...
async function seedDatabase() {
  ...
  const reels = await Reel.insertMany([
    ...
    // ── Additional reels for scrolling depth ──
    {
      user: demoUser._id,
      agency: agencies[7]._id,
      caption: 'Desert sunset and camel silhouettes 🐪🌅 Jaisalmer hits different!',
      tags: ['#Rajasthan', '#Desert', '#Jaisalmer'],
      ...
      shares: 1800,
      imageType: 'desert',
      musicTitle: 'Desert Wind - Rajasthan Folk',
      creatorHandle: '@desert_nomad',
      creatorTier: 'gold'
    },
    {
      user: demoUser._id,
      agency: agencies[16]._id,
      caption: 'Riding through Khardung La at 5,359m 🏍️ Highest motorable road in the world!',
      tags: ['#Ladakh', '#KhardungLa', '#BikeTrip'],
      ...
      shares: 3200,
      imageType: 'mountain',
      musicTitle: 'Highway Freedom - Moto Mix',
      creatorHandle: '@ladakh_rider',
      creatorTier: 'gold'
    },
    {
      user: demoUser._id,
      agency: agencies[14]._id,
      caption: 'Parasailing over Baga Beach! The view from up there is insane 🪂',
      tags: ['#Goa', '#Parasailing', '#BeachLife'],
      ...
      shares: 1100,
      imageType: 'beach',
      musicTitle: 'Beach Vibes - Summer Hit',
      creatorHandle: '@goa_thrills',
      creatorTier: 'silver'
    },
    {
      user: demoUser._id,
      agency: agencies[19]._id,
      caption: 'The double-decker living root bridge is REAL 🌿🌉 3,500 steps worth it!',
      tags: ['#Meghalaya', '#RootBridge', '#Nature'],
      ...
      shares: 2400,
      imageType: 'jungle',
      musicTitle: 'Rainforest Sounds - Ambient',
      creatorHandle: '@northeast_wanderer',
      creatorTier: 'gold'
    },
    {
      user: demoUser._id,
      agency: agencies[22]._id,
      caption: 'Hampi at sunrise — ancient ruins, golden light, pure magic ✨🏛️',
      tags: ['#Hampi', '#Heritage', '#Karnataka'],
      location: 'Hampi, Karnataka',
      isAffiliate: false,
      likes: 5400,
      comments: 289,
      shares: 750,
      imageType: 'desert',
      musicTitle: 'Ancient Echoes - Ambient',
      creatorHandle: '@ruins_explorer',
      creatorTier: 'bronze'
    },
    {
      user: demoUser._id,
      agency: agencies[8]._id,
      caption: 'Lake Pichola boat ride at dusk 🚣‍♂️ Udaipur is the Venice of the East!',
      tags: ['#Udaipur', '#Rajasthan', '#Heritage'],
      ...
      shares: 1600,
      imageType: 'desert',
      musicTitle: 'Royal Strings - Classical',
      creatorHandle: '@udaipur_royal',
      creatorTier: 'silver'
    },
    {
      user: demoUser._id,
      agency: agencies[17]._id,
      caption: 'Walking on a FROZEN RIVER 🥶🏔️ Chadar Trek is the ultimate bucket list!',
      tags: ['#ChadarTrek', '#Ladakh', '#Extreme'],
      ...
      shares: 4100,
      imageType: 'snow',
      musicTitle: 'Ice Crystals - Epic',
      creatorHandle: '@extreme_trekker',
      creatorTier: 'gold'
    },
    {
      user: demoUser._id,
      agency: agencies[11]._id,
      caption: 'Lost in the tea gardens of Munnar 🍵💚 Endless green as far as the eye can see',
      tags: ['#Munnar', '#Kerala', '#TeaGarden'],
      location: 'Munnar, Kerala',
      isAffiliate: false,
      likes: 6700,
      comments: 345,
      shares: 920,
      imageType: 'jungle',
      musicTitle: 'Green Valley - Lo-Fi',
      creatorHandle: '@tea_trails',
      creatorTier: 'silver'
    },
    {
      user: demoUser._id,
      agency: agencies[13]._id,
      caption: 'Private yacht in South Goa 🛥️✨ Living the dream for a weekend!',
      tags: ['#Goa', '#Yacht', '#Luxury'],
      location: 'South Goa',
      isAffiliate: true,
      likes: 10200,
      comments: 698,
      shares: 2300,
      imageType: 'beach',
      musicTitle: 'Ocean Breeze - Deep House',
      creatorHandle: '@luxury_goa',
      creatorTier: 'gold'
    },
    {
      user: demoUser._id,
      agency: agencies[21]._id,
      caption: 'Coorg coffee estate mornings ☕🌄 The aroma wakes you up before the alarm',
      tags: ['#Coorg', '#Coffee', '#Karnataka'],
      location: 'Coorg, Karnataka',
      isAffiliate: false,
      likes: 4200,
      comments: 198,
      shares: 560,
      imageType: 'jungle',
      musicTitle: 'Morning Brew - Acoustic',
      creatorHandle: '@coorg_vibes',
      creatorTier: 'bronze'
    }
  ]);
